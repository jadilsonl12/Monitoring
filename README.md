Essa é uma aplicação criada para obtenção de uma das notas da disciplina de Programação Móvel do curso de Sistemas de Informação do Instituto Federal de Alagoas(IFAL) Campus Arapiraca.
